...
declare const wx: {
    ...
    onAccelerometerChange(callback: (res) => void): void;
    startAccelerometer(object: { interval: string,success?: (res: any) => void, fail?: (res: any) => void, complete?: (res: any) => void }): void;
    ...
    onCompassChange(callback: (res) => void): void;
    ...
    startGyroscope(object: { interval: string, success: (res: any) => void, fail: (res: any) => void, complete: (res: any) => void }): void;
    stopGyroscope(object: { success: (res: any) => void, fail: (res: any) => void, complete: (res: any) => void }): void;
    onGyroscopeChange(callback: (res) => void): void;
    /**
     * 获取网络类型
     */
    ...
    downloadFile(object: { url: string, success: (res: any) => void, fail: (res: any) => void }): DownloadTask;
    /**
     * 发起网络请求。
     */
    ...
    showModal(object: { title: string, content: string, cancelText: string, confirmText: string, success: (res: any) => void }): void;
    showModal(object: { title: string, showCancel: boolean, content: string, cancelText: string, confirmText: string, success: (res: any) => void }): void;
    showModal(object: { title: string, showCancel: boolean, content: string, cancelText: string, confirmText: string, success: (res: any) => void, fail: (res: any) => void }): void;
    showModal(object: { title: string, content: string, showCancel: boolean, cancelText: string, cancelColor: string, confirmText: string, confirmColor: string, success: (res: any) => void }): void;
    /**
     * 显示消息提示框
     */
